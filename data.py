...
pole_t1.grid(row=0, column = 2, stick = W+E)
pole_t2.grid(row=2, column = 2, stick = W+E)
pole_t3.grid(row=4, column = 2, stick = W+E)
pole_t4.grid(row=6, column = 2, stick = W+E)
pole_t5.grid(row=8, column = 2, stick = W+E)

etykieta1.grid(row=0, column = 1, stick = W)
etykieta2.grid(row=2, column = 1, stick = W)
etykieta3.grid(row=4, column = 1, stick = W)
etykieta4.grid(row=6, column = 1, stick = W)
etykieta5.grid(row=8, column = 1, stick = W)
